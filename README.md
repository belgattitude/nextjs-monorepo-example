...
| Name                    | Description                                                                                                                          |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `g:changeset`           | Add a changeset to declare a new version                                                                                             |
| `g:typecheck`           | Run typechecks in all workspaces                                                                                                     |
| `g:lint`                | Display linter issues in all workspaces                                                                                              |
| `g:lint --fix`          | Attempt to run linter auto-fix in all workspaces                                                                                     |
| `g:lint-styles`         | Display css stylelint issues in all workspaces                                                                                       |
| `g:lint-styles --fix`   | Attempt to run stylelint auto-fix issues in all workspaces                                                                           |
| `g:test`                | Run unit and e2e tests in all workspaces                                                                                             |
| `g:test-unit`           | Run unit tests in all workspaces                                                                                                     |
| `g:test-e2e`            | Run e2e tests in all workspaces                                                                                                      |
| `g:build`               | Run build in all workspaces                                                                                                          |
| `g:clean`               | Clean builds in all workspaces                                                                                                       |
| `g:check-dist`          | Ensure build dist files passes es2017 (run `g:build` first).                                                                         |
| `g:check-size`          | Ensure browser dist files are within size limit (run `g:build` first).                                                               |
| `clean:global-cache`    | Clean tooling caches (eslint, jest...)                                                                                               |
| `deps:check --dep dev`  | Will print what packages can be upgraded globally (see also [.ncurc.yml](https://github.com/sortlist/packages/blob/main/.ncurc.yml)) |
| `deps:update --dep dev` | Apply possible updates (run `yarn install && yarn dedupe` after)                                                                     |
| `check:install`         | Verify if there's no peer-deps missing in packages                                                                                   |
| `install:playwright`    | Install playwright for e2e                                                                                                           |
| `deduplicate`           | Built-in yarn deduplication of the lock file                                                                                         |
