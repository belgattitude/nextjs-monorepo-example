...
describe('serverSideTranslations', function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              expect(_fs["default"].existsSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/en-US'));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              expect(_fs["default"].existsSync).toHaveBeenCalledTimes(6);
              expect(_fs["default"].existsSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/en-US'));
              expect(_fs["default"].existsSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/fr'));
              expect(_fs["default"].readdirSync).toHaveBeenCalledTimes(4);
              expect(_fs["default"].readdirSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/en-US'));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              expect(_fs["default"].existsSync).toHaveBeenCalledTimes(8);
              expect(_fs["default"].readdirSync).toHaveBeenCalledTimes(6);
              expect(_fs["default"].readdirSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/en-US'));
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              expect(_fs["default"].existsSync).toHaveBeenCalledTimes(7);
              expect(_fs["default"].readdirSync).toHaveBeenCalledTimes(5);
              expect(_fs["default"].readdirSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/de-CH'));
              expect(_fs["default"].readdirSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/en-US'));
              expect(_fs["default"].readdirSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/fr-BE'));
  ...
  it('does load fallback locales with fallbackLng (as array)', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8() {
    ...
    return _regenerator["default"].wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.next = 2;
            return (0, _serverSideTranslations.serverSideTranslations)('en-US', ['common'], {
              fallbackLng: ['de'],
              i18n: {
                defaultLocale: 'de',
  ...
  it('does load fallback locales with fallbackLng (as object)', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9() {
  ...
  it('does load fallback locales with fallbackLng (as function)', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10() {
  ...
  describe('When nonExplicitSupportedLngs is true', function () {
    it('does load fallback locales', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11() {
    ...
    it('does load fallback locales with fallbackLng (as array)', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12() {
    ...
    it('does load fallback locales with fallbackLng (as object)', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee13() {
    ...
    it('does thrown an error with fallbackLng (as function)', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee14() {
      var config;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              _context14.next = 3;
              return expect((0, _serverSideTranslations.serverSideTranslations)('de-DE', ['common'], config)).rejects.toThrow('If nonExplicitSupportedLngs is true, no functions are allowed for fallbackLng');
            case 3:
            case "end":
  ...
  it('returns props', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee15() {
    var props;
  ...
  it('calls reloadResources when reloadOnPrerender option is true', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee16() {
  ...
  it('does not call reloadResources when reloadOnPrerender option is false', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee17() {
  ...
  it('throws if a function is used for localePath and namespaces are not provided', /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee18() {
