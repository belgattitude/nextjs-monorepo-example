...
import type { CatFactsTypes } from './sources/CatFacts/types';
import * as importedModule$0 from "./sources/CatFacts/schemaWithAnnotations";
...
export type MeshContext = CatFactsTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".mesh/sources/CatFacts/schemaWithAnnotations":
...
const catFactsHandler = new OpenapiHandler({
              name: "CatFacts",
              config: {"source":"https://catfact.ninja/docs/api-docs.json","endpoint":"https://catfact.ninja/"},
              baseDir,
              cache,
              pubsub,
